...
public:
    QJHilbertFilter();
    void setSize(int N);
    std::vector<JFFT::cpx_type> getKernel();
private:
...
public:
    ...
    void setdelay(double fractdelay_)
    {
        ...
        std::fill(buff.begin(), buff.end(), T(0));
        buffptr=0;
    }
    T update(T sig)
    {
...
public:
    ...
    void setlength(int length)
    {
        ...
        for(int i=0;i<(int)MABuffer.size();i++)MABuffer[i]=(T)0;
        MAPtr=0;
        Val=0;
    }
    void clear()
